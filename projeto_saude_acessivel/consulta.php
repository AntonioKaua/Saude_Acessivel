...
<form id="form1" class="especialidadesForm" action="process/process_consulta.php" method="POST" target="_self">
  ...
  <?php foreach($especialidades as $especialidade): ?>
    <label class="especialidadesLabel" onclick="submitForm('<?php echo $especialidade['especialidade']; ?>')"><?php echo $especialidade['especialidade']; ?></label>
    <input type="text" name="especialidade" hidden id="<?php echo $especialidade['especialidade']; ?>" value="">
    <br>
  <?php endforeach; ?>
</form>

<form id="form2" class="especialidadesForm" action="process/process_consulta.php" method="POST" style="display: none;" target="_self">
